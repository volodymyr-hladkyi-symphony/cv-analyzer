...
case "$1" in
    ...
    *)
        ...
        echo ""
        echo "Commands:"
        echo "  start     - Start all services in production mode (profile optional: main|groq|docker-llm)"
        echo "  stop      - Stop all services"
        echo "  restart   - Restart all services (profile optional: main|groq|docker-llm)"
        echo "  build     - Build all Docker images (profile optional: main|groq|docker-llm)"
        echo "  logs      - Show logs (all services or specific service)"
        echo "  dev       - Start services in development mode with hot reloading (profile optional: dev|groq|docker-llm)"
